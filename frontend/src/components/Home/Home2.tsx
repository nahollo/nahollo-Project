          ...
          <Col lg={7} className="home-about-description">
            <div className="section-copy-block">
              ...
              <p className="section-lead">
                홈에서는 긴 설명 대신, 어떤 기준으로 화면과 서비스 흐름을 다루는지만 짧고 선명하게 보여줍니다.
              </p>
              ...
              <div className="about-preview-actions">
                <Link to="/canvas" className="about-preview-link">
                  실시간 캔버스 열기
                </Link>
              </div>
            </div>
          ...
          <Col lg={5}>
            <div className="profile-surface surface-card">
              ...
              <div className="surface-card-footer">
                <span>Canvas에서 실시간으로 참여할 수 있는 공간</span>
                <strong>공유 보드 · 픽셀 드로잉 · 히스토리 갤러리</strong>
              </div>
            </div>
          </Col>
        </Row>
